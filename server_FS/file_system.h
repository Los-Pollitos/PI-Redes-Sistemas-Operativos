...
typedef struct directory_entry {
  int block;
  int size;
  int file_pointer; // points to the current character for read and write
                    // operations
  time_t date;
...
public:
  ...
  // For permissions
  bool can_change_permissions(std::string user, std::string name);
  bool modify_permissions(std::string user, std::string name, int new_user,
                          int new_group, int new_all);
  bool get_permissions(std::string user, std::string name, int &result_user,
