...
void auditor::on_refresh_button_clicked(){
    ...
    system("cp ../log_file/Data_LOG.txt ../log_file/temp.txt");
    std::ifstream  log_file ("../log_file/temp.txt");
    if (log_file.is_open()) {
        std::string text = "";
...
void auditor::on_search_button_clicked() {
    ...
    if (to_find != "") {
    	system("cp ../log_file/Data_LOG.txt ../temp.txt");
