...
class FS {
  ...
  public:
    ...
    bool modify_permissions(std::string user, std::string name, int new_user, int new_group, int new_all);
    bool get_permissions(std::string user, std::string name, int& result_user, int& result_group, int& result_all);
};
